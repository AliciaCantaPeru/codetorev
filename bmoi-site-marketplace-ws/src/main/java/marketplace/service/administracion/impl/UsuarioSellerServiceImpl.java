...
import marketplace.service.administracion.UsuarioSellerService;
...
@Service
public class UsuarioSellerServiceImpl implements UsuarioSellerService {
    ...
    public PageImpl<UsuarioOutDto> listar(UsuarioInDto in) throws Exception {
        ...
        PageImpl<SellerPersonas> pageEntity = sellerPersonasRepository.listarSellerPersonas(TipoUsuarioLogin.SELLER.getValor(), in.getSortCampo(), in.getSortOrden(), in.getTexto(), idSeller, pageRequest, true);
    ...
    public UsuarioMantDto guardar(UsuarioMantDto mantenimientoDto) throws Exception {
        sellerCuentasRepository.validaObtenerCorreo(mantenimientoDto.getIdPersonaLogeada(), TipoUsuarioLogin.SELLER.getValor());
    ...
    public void eliminar(int ipPersonaLogeada, List<Integer> listaId) throws Exception {
        sellerCuentasRepository.validaObtenerCorreo(ipPersonaLogeada, TipoUsuarioLogin.SELLER.getValor());
    ...
    public List<OpcionPersona> listarOpcionPersonas(int idPersonaLogeada, int idSeller, Integer idPersonaSeller) throws Exception {
        ...
        List<SellerPersonaOpcionEntity> listaOpcionEntity = sellerPersonasRepository.listarOpcionPersonaSellerCuenta(TipoUsuarioLogin.SELLER.getValor(), idSeller, idPersonaSeller == -1 ? null : idPersonaSeller);
    ...
    public List<Opcion> listarOpcionRoles(int idPersonaLogeada) throws Exception {
        sellerCuentasRepository.validaObtenerCorreo(idPersonaLogeada, TipoUsuarioLogin.SELLER.getValor());
