 ...
 */
public class StyleRowSpanHeaderImpar extends ConditionStyleExpression implements CustomExpression {

    private String fieldName;
    private Integer numeroFila = 1;
    private Integer numeroGrupo = 1;
    private String datoAnterior;

    public StyleRowSpanHeaderImpar(String fieldName) {
    ...
    public Object evaluate(Map fields, Map variables, Map parameters) {
        ...
        if (currentValue instanceof String) {
            ...
            condition = numeroFila == 1 && numeroGrupo % 2 == 1;
            numeroFila++;
