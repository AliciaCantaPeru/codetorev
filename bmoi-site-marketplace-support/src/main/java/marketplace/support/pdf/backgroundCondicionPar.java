 ...
 */
public class backgroundCondicionPar extends ConditionStyleExpression implements CustomExpression {

    private String fieldName;
    private Integer numeroFila = 1;
    private String datoAnterior;

    public backgroundCondicionPar(String fieldName) {
