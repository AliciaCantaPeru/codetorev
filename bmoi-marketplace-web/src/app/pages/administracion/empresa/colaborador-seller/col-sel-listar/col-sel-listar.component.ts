...
@Component({
  selector: 'app-col-sel-listar',
  templateUrl: './col-sel-listar.component.html',
  styleUrls: ['./col-sel-listar.component.scss'],
})
export class ColSelListarComponent implements OnInit {
  ...
  constructor(
    ...
    private colaborador: ColaboradorSellerService,
  ...
  abrirCrearEditarDialogo(data: ColaboradorSellerIn) {
    ...
    this.router.navigate([PathApp.routeColSellerReg, id]);
  }
