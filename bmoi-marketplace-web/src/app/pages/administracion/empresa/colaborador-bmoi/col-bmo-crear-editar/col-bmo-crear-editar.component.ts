...
@Component({
  selector: 'app-col-bmo-crear-editar',
  templateUrl: './col-bmo-crear-editar.component.html',
  styleUrls: ['./col-bmo-crear-editar.component.scss'],
})
export class ColBmoCrearEditarComponent implements OnInit {
  ...
  id;
  constructor(
    private colaboradorService: ColaboradorBmoiService,
  ...
  guardar() {
    ...
    if (this.id === null) {
      this.colaboradorService.guardar(mant).subscribe(
        (res) => {
          this.router.navigate([PathApp.routeColBmoi]);
